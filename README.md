...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-ecume-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12935&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ecume-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ecume` can be installed with:

```
conda install r-ecume
```

It is possible to list all of the versions of `r-ecume` available on your platform with:
